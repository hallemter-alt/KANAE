...
const L = {
  ...
  zh: {
    label: 'Market Insight',
    title: '市场数据与行业分析',
    subtitle: '从公共统计与行业调查解读不动产市场潮流',
    lead: '不动产的判断需要安静的依据。我们基于国家、行业团体、研究机构公布的一手数据，描绘市场的轮廓。数字不加修饰，如实呈现。',
    chartsTitle: '主要指标推移',
    chartsSub: '基于公开统计的参考值（均注明出处）',
    source: '出处',
    reportsTitle: '公共机构·行业团体调查资料',
    reportsSub: '通往一手信息的安静入口',
    catGov: '政府·公共机构',
    catAssoc: '行业团体',
    catResearch: '研究机构·调查公司',
    visit: '访问官方网站',
    disclaimer:
      '※ 本页图表基于各机构公开资料的年度代表值·概数，准确数值请务必查阅各出处的原始资料。刊载内容不构成对未来市场走向的保证。',
    ctaTitle: '数据之外，是个别的咨询',
    ctaText: '市场整体的潮流与个别物业的判断是两回事。我们将根据您的情况，静静地为您引路。',
    ctaBtn: '联系我们',
  },
  en: {
    label: 'Market Insight',
