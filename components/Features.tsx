      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="text-sm font-semibold text-gray-700">宅建免許</p>
            <p className="text-xs text-gray-500">東京都知事(1)第107157号</p>
          </div>
          <div className="text-center">
            <div className="mb-2">
              <svg className="w-12 h-12 mx-auto text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-sm font-semibold text-gray-700">専門資格</p>
            <p className="text-xs text-gray-500">宅建士・一級建築士在籍</p>
          </div>
          <div className="text-center">
            <div className="mb-2">
              <svg className="w-12 h-12 mx-auto text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-sm font-semibold text-gray-700">協会加盟</p>
            <p className="text-xs text-gray-500">東京都宅建協会</p>
          </div>
          <div className="text-center">
            <div className="mb-2">
              <svg className="w-12 h-12 mx-auto text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-sm font-semibold text-gray-700">多言語対応</p>
            <p className="text-xs text-gray-500">日・中・英対応</p>
          </div>
        </div>
      </div>
    </section>
