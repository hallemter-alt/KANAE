...
export const translations = {
  ...
  zh: {
    ...
    philosophy: {
      ...
      subtitle: '我们的行动准则与目标',
      heroTitle: '企业理念',
      heroSubtitle: '追求物质与精神的双重幸福，以利他之心创造通往世界的价值',
      missionCardTitle: '追求物质与精神的双重幸福',
      missionCardDesc: '实现客户、员工以及整个社会的物质与精神双重富足，为所有利益相关者的幸福做出贡献。',
      missionCheck1: '将客户的满意与幸福置于首位',
      missionCheck2: '实现员工的成长与工作价值',
      missionCheck3: '为社会做出贡献并创造价值',
      visionCardTitle: '以利他之心创造价值',
      visionCardDesc: '以利他之心，创造通往世界的价值，致力于成为房地产行业的领军企业。',
      visionCheck1: '珍视体贴他人的心',
      visionCheck2: '提供创新服务',
      visionCheck3: '创造行业标准',
      guidelinesTitle: '行动准则',
      guideline1Title: '诚实',
      guideline1Desc: '在所有行动中，以诚实为第一要义。对客户、合作伙伴和社会保持诚实、透明的态度。',
      guideline2Title: '挑战',
      guideline2Desc: '不满足于现状，不断挑战创造新价值。不惧怕失败，珍视持续学习的姿态。',
      guideline3Title: '感恩',
      guideline3Desc: '对所有相遇和缘分心存感激。永远不忘对客户、同事和社会的感谢。',
      promisesTitle: '我们的承诺',
      promiseCustomerTitle: '对客户的承诺',
      promiseCustomerItems: [
        '提供最优质的服务和满意度',
        '从客户角度出发提供建议',
        '迅速而周到地响应需求',
    ...
    about: {
      ...
      service1Title: '租赁业务',
      service1Desc: '为客户推荐符合生活方式的最优租赁房源。',
      service2Title: '买卖业务',
      service2Desc: '从房产买卖中介到投资物业介绍，全方位对应。',
      service3Title: '管理业务',
      service3Desc: '妥善管理业主的重要资产，支持稳定收益。',
      service4Title: '民宿业务',
      service4Desc: '运用民宿运营专业知识，支持收益最大化。',
      ourPhilosophyTitle: '我们的理念',
      ourPhilosophySubtitle: '追求物质与精神的双重幸福，以利他之心创造通往世界的价值',
      ourPhilosophyButton: '查看企业理念',
      accessTitle: '交通方式',
      locationTitle: '地址',
      accessDetailTitle: '交通信息',
      contactSectionTitle: '联系我们',
      contactSectionDesc: '如有关于房产或服务的问题，欢迎随时联系我们。',
      contactButton: '点击此处联系',
      companyInfo: '公司信息',
      companyName: '公司名称',
      representative: '代表人',
      established: '成立日期',
      ...
      licenseNumber: '许可证编号',
      licenseNumberValue: '宅地建物取引业 东京都知事(1)第107157号',
      associations: '加盟团体',
      associationsValue: '公益社团法人 全国宅地建物取引业协会联合会、公益社团法人 东京都宅地建物取引业协会',
      strengths: '我们的优势',
    ...
    features: {
      ...
      items: [
        ...
        {
          title: '安心支持',
          description: '配备持证房产交易士及一级建筑师，以专业知识支持客户',
          iconPath: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
        },
        {
          title: 'IT化推进',
          description: '与ITANDI・OneStep PMS等平台联动，实现顺畅合约与管理',
          iconPath: 'M13 10V3L4 14h7v7l9-11h-7z',
        },
        {
          title: '透明收费体系',
          description: '当场确认初期费用及税金计算，无任何隐藏费用',
          iconPath: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
        },
        {
          title: '一站式服务',
    ...
    contact: {
      ...
      formTitle: '咨询表单',
      formDescription: '请填写以下表单并提交。我们的工作人员将在3个工作日内与您联系。',
      name: '姓名',
      namePlaceholder: '张三',
      nameRequired: '请输入姓名',
      emailLabel: '邮箱地址',
      ...
      phoneOptional: '选填',
      inquiryType: '咨询类型',
      inquiryTypeViewing: '预约看房',
      inquiryTypeInquiry: '一般咨询',
      inquiryTypeApplication: '入住申请',
      inquiryTypeOther: '其他',
      message: '咨询内容',
    ...
    properties: {
      title: '投资收益物业搜索',
      subtitle: '搜索东京都内投资收益物业',
      quickSearch: '快速搜索',
      detailedSearch: '详细搜索',
      showAllProperties: '显示全部物业',
      propertyView: '物业列表',
      wardView: '按区域搜索',
      totalResults: '符合条件的物业：',
      resultsCount: '件',
      activeFilters: '个条件',
      clearAll: '清除全部',
      geography: '地理位置',
      ...
      wholeOffice: '整栋办公楼',
      wholeApartment: '整栋公寓',
      incomeProperty: '整栋收益物业',
      area: '面积',
      landArea: '土地面积（㎡）',
      buildingArea: '建筑面积（㎡）',
      areaMin: '下限',
      areaMax: '上限',
      advancedFilters: '详细条件',
      expectedYield: '预期收益率（%）',
      yieldMin: '下限（例：4.0）',
      yieldMax: '上限（例：10.0）',
      buildingAge: '楼龄',
