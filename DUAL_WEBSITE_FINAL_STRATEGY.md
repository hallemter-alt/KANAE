...
### www.kanae-tokyo.com（KANAE 株式会社）
```
行業：不動產
業務：
- 不動產投資
...
4. 管理服務 (/ja/management)
   - 物業管理服務
   - 租客管理
   - 收益管理

5. 投資諮詢 (/ja/investment)
   - 投資分析
   - 市場趨勢
   - 回報計算
...
2. 天然精油 (/ja/essential-oils)
   - 精油產品目錄
   - 產品規格
   - 應用領域
   - 認證資訊

3. 香料產品 (/ja/fragrances)
   - 香料類型
   - 化妝品用香料
   - 食品級香料
   - 定制服務

4. 化妝品原料 (/ja/cosmetic-ingredients)
   - 原料目錄
   - 品質認證
   - 供應鏈優勢
   - MOQ 和價格

5. 貿易服務 (/ja/trading-services)
   - 進出口服務
   - 物流配送
   - 品質保證
   - 客製化採購
...
英文關鍵詞：
- Essential oils wholesale Japan
- Cosmetic ingredients Tokyo
- Fragrance trading
- Natural oils supplier
- Beauty ingredients Japan

結構化數據：
- @type: Organization (貿易公司)
- @type: Product (產品目錄)
- 服務：批發、貿易、物流
```
...
```json
{
  ...
  "description": "東京都を中心とした不動産投資・賃貸・売買サービス",
  "address": {
    "@type": "PostalAddress",
...
3. **更新結構化數據**
   - [ ] 從 RealEstateAgent 改為 Organization
   - [ ] 添加 Product 結構化數據
   - [ ] 更新公司描述
...
4. **更新 SEO Metadata**
   - [ ] Title: 從不動產改為貿易/精油
   - [ ] Description: 強調貿易業務
   - [ ] Keywords: 精油、香料、化妝品原料

---

### 階段 2：Google Search Console 設置（本週）🟡
