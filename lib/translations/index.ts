...
export const translations = {
  ja: {
    ...
    sale: {
      title: '売買物件検索',
      subtitle: '住宅用・投資用の多様な物件をご提供',
      categorySelect: '物件カテゴリーを選択',
      all: '全て',
      allProperties: '全物件を表示',
      residential: '住宅用',
      residentialDesc: 'マンション・戸建',
      investment: '投資用',
      investmentDesc: '収益物件',
      allPropertiesTitle: '全物件',
      residentialTitle: '住宅用物件',
      investmentTitle: '投資用物件',
      totalCount: '全',
      items: '件',
      sortBy: '並び替え：',
      ...
      sortYieldDesc: '利回り：高い順',
      sortCompletionDesc: '築年数：新しい順',
      noResults: '物件が見つかりませんでした',
      noResultsDesc: '検索条件を変更して再度お試しください',
      showAll: '全物件を表示',
      prev: '前へ',
      next: '次へ',
      ctaTitle: '物件に関するお問い合わせ',
      ctaDescription: '専門スタッフが丁寧にサポートいたします',
      ctaContact: 'お問い合わせ',
      detailedSearch: '詳細検索',
    },
  ...
  en: {
    ...
    sale: {
      ...
      subtitle: 'Diverse properties for residential and investment use',
      categorySelect: 'Select Property Category',
      all: 'All',
      allProperties: 'Show All Properties',
      residential: 'Residential',
      residentialDesc: 'Condos & Houses',
      investment: 'Investment',
      investmentDesc: 'Income Properties',
      allPropertiesTitle: 'All Properties',
      residentialTitle: 'Residential Properties',
      investmentTitle: 'Investment Properties',
      totalCount: 'Total',
      items: 'properties',
      sortBy: 'Sort by:',
      ...
      sortYieldDesc: 'Yield: High to Low',
      sortCompletionDesc: 'Age: Newest First',
      noResults: 'No properties found',
      noResultsDesc: 'Please change your search criteria and try again',
      showAll: 'Show All Properties',
      prev: 'Previous',
      next: 'Next',
      ctaTitle: 'Property Inquiries',
      ctaDescription: 'Our professional staff will provide careful support',
    ...
    properties: {
      ...
      subtitle: 'Search for investment properties in Tokyo',
      quickSearch: 'Quick Search',
      detailedSearch: 'Detailed Search',
      showAllProperties: 'Show All Properties',
      propertyView: 'Property List',
      wardView: 'Search by Area',
      totalResults: 'Matching properties:',
      resultsCount: 'properties',
      activeFilters: 'filters',
      clearAll: 'Clear All',
      geography: 'Geography',
      ward: 'Ward',
      selectWard: 'All Areas',
      railway: 'Railway',
      ...
      wholeOffice: 'Whole Office',
      wholeApartment: 'Whole Apartment',
      incomeProperty: 'Whole Income',
      area: 'Area',
      landArea: 'Land Area (㎡)',
